...
class SampaConfig: public IndefiniteMapi // changed from MAPI to IndefiniteMAPI
{
...
public:
	SampaConfig();
	void processExecution(); // IndefiniteMAPI allows you to override processExecution function instead of proccessInput and Output Message
};
